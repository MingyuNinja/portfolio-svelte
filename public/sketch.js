...
function setup() {
    ...
    backgroundSystem = new ParticleSystem(10, color(10, 150, 190, 20));
    backgroundSystem2 = new ParticleSystem(14, color(50, 150, 230, 40));
    mouseSystem = new ParticleSystem(8, color(5, 120, 240, 60));
}
